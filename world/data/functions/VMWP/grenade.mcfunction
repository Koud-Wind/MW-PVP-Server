...
#execute @a[tag=FragG,m=!3] ~ ~ ~ scoreboard players tag @e[type=mwc:smokegrenade260,r=4,c=1,tag=!AGrenade] add FragG
scoreboard players tag @e[type=mwc:smokegrenade260,tag=!AGrenade] add FragG {CustomName:"§fFrag Grenade"}
...
execute @e[type=mwc:smokegrenade260,tag=ExplosiveG] ~ ~ ~ summon minecraft:creeper ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0,Duration:3,ShowParticles:0b}],Fuse:4s,NoGravity:1b,ignited:1b,ExplosionRadius:9b,CustomName:"[Frag Grenade]",Silent:1b,CustomNameVisible:0b,Tags:["FragGrenade"]}
...
#execute @a[tag=IncendiaryG,m=!3] ~ ~ ~ scoreboard players tag @e[type=mwc:smokegrenade260,r=4,c=1,tag=!AGrenade] add IncendiaryG
scoreboard players tag @e[type=mwc:smokegrenade260,tag=!AGrenade] add IncendiaryG {CustomName:"§fMolotov Cocktail"}
...
#execute @a[tag=StunG,m=!3] ~ ~ ~ scoreboard players tag @e[type=mwc:smokegrenade260,r=4,c=1,tag=!AGrenade] add StunG
scoreboard players tag @e[type=mwc:smokegrenade260,tag=!AGrenade] add StunG {CustomName:"§fStun Grenade"}
...
#execute @a[tag=SmokeG,m=!3] ~ ~ ~ scoreboard players tag @e[type=mwc:smokegrenade260,r=4,c=1,tag=!AGrenade] add SmokeG
scoreboard players tag @e[type=mwc:smokegrenade260,tag=!AGrenade] add SmokeG {CustomName:"§fSmoke Grenade"}
