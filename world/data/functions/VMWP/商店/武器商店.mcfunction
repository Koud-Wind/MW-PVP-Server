...
execute @e[tag=全局游戏] ~ ~ ~ scoreboard players tag @a[score_狙击枪&射手步枪页面_min=20,score_狙击枪&射手步枪页面=20,tag=游戏中,score_爆破-金钱_min=30,score_选择的商店=1,score_选择的商店_min=1] add 购买AX50
...
scoreboard players remove @a[tag=购买AX50] 爆破-金钱 30
