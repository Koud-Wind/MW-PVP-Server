...
scoreboard objectives remove CT-Death
scoreboard objectives remove CT-Occupy
scoreboard objectives remove CT-Prompt
scoreboard objectives remove CT-CTLife
scoreboard objectives remove CT-TLife
scoreboard objectives remove CT-lifeC

function vmwp:scoreboard
scoreboard players tag @e remove start4