...
#完胜
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players add @a[team=CT,tag=InGame] note 150
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players add @a[team=CT,tag=InGame] wins 1
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players operation @a[team=CT,tag=InGame] money /= §fdivision money
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ execute @a[team=CT,tag=InGame] ~ ~ ~ scoreboard players operation @s note += @s money
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players add @a[team=T,tag=InGame] note 100
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players remove @a[team=T,tag=InGame,score_wins_min=1] wins 1
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ execute @a[team=CT,tag=InGame] ~ ~ ~ tellraw @s [{"text":"§eComplete victory! +150 note +"},{"score":{"objective":"money","name":"@s"},"color":"yellow"},{"text":" §enote"}]
execute @e[tag=VMW,score_CT-CTScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ tellraw @a[team=T,tag=InGame] [{"text":"§eThe match is over! +100 note"}]
...
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players add @a[team=T,tag=InGame] note 150
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players add @a[team=T,tag=InGame] wins 1
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players operation @a[team=T,tag=InGame] money /= §fdivision money
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ execute @a[team=T,tag=InGame] ~ ~ ~ scoreboard players operation @s note += @s money
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players add @a[team=CT,tag=InGame] note 100
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ scoreboard players remove @a[team=CT,tag=InGame,score_wins_min=1] wins 1
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ execute @a[team=T,tag=InGame] ~ ~ ~ tellraw @s [{"text":"§eComplete victory! +150 note +"},{"score":{"objective":"money","name":"@s"},"color":"yellow"},{"text":" §enote"}]
execute @e[tag=VMW,score_CT-TScore_min=4] ~ ~ ~ execute @s[score_CT-WaitT=0] ~ ~ ~ tellraw @a[team=CT,tag=InGame] [{"text":"§eThe match is over! +100 note"}]
...
execute @e[tag=VMW,score_CT-TR_min=4800] ~ ~ ~ kill @e[type=mw:smokegrenade260]
