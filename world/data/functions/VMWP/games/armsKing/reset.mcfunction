...
scoreboard players reset @a PC-CrownT
...
#execute @e[tag=VMW] ~ ~ ~ setblock -64 164 1075 minecraft:chest 3 keep {Items:[{Slot:22b,id:"minecraft:paper",Count:1b,tag:{display:{Name:"§f+15 note"},tag:["15note"]},Damage:0s}]}
...
scoreboard objectives remove PC-CrownT


function vmwp:scoreboard
scoreboard players tag @e remove start3