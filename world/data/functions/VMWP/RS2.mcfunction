...
execute @e[tag=VMW] ~ ~ ~ replaceitem entity @a[tag=S-Map] slot.hotbar.2 minecraft:written_book 1 0 {tag:["NO"],HideFlags:32,author:"null",title:"Select Map",pages:["[{\"text\":\"§5§l§oSelect maps\\n\\n\"},{\"text\":\"§b§l§nmap1\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 1\"}},{\"text\":\"§b§l§nmap2\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 2\"}},{\"text\":\"§b§l§nmap3\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 3\"}},{\"text\":\"§b§l§nmap4\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 4\"}},{\"text\":\"§b§l§nmap5\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 5\"}},{\"text\":\"§b§l§nmap6\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 6\"}},{\"text\":\"\\n§9§nReplace game mode\\n\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger S-Map set 20\"}}]"]}
execute @e[tag=VMW] ~ ~ ~ replaceitem entity @a[tag=Preparing] slot.hotbar.7 mw:remington_700 1 0 {tag:["NO"],IUuidLeast:-4835354131143399095L,AtId:[I;5629,0,0,0,0,0,0,0,0,0,5166,0,0,0,5291,4870,0,0,0,0,0,0,0,0,0,4765,0],Ammo:0,IUuidMost:-377960153562396255L,Instance:[B;-32B,83B,21B,-112B,-126B,43B,-31B,45B,117B,49B,126B,79B,17B,126B,62B,-127B,0B,0B,0B,9B,-6B,-63B,55B,62B,43B,-87B,73B,-95B,-68B,-27B,95B,9B,89B,-6B,-23B,73B,0B,0B,20B,10B,0B,0B,0B,7B,0B,0B,0B,0B,0B,0B,0B,56B,75B,99B,82B,108B,-118B,-87B,-71B,14B,-97B,-92B,100B,-74B,-111B,106B,61B,-40B,0B,0B,0B,22B,27B,0B,0B,21B,-3B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,19B,-83B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,20B,46B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,20B,-85B,0B,0B,19B,6B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,18B,-99B,0B,0B,0B,0B,27B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,-1B,0B,0B,0B,0B,0B,65B,32B,0B,0B,0B,0B,0B,1B,62B,15B,92B,41B,0B,0B,0B,0B,0B,0B,0B,1B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B,0B],display:{Name:"§fLoad sight"}}
