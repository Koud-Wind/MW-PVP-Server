...
scoreboard players reset @a 个人-分数
...
scoreboard objectives remove 个人-分数
scoreboard objectives remove 个人-游戏数
scoreboard objectives remove 个人-等待时间
scoreboard objectives remove 个人-人数



function vmwp:计分板
scoreboard players tag @e remove 开始5