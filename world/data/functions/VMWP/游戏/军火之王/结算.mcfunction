tellraw @a[tag=!PVE-游戏中] [{"text":"§b§l军火之王前三名排行:\n"},{"text":"§a1rd: "},{"selector":"@a[tag=1rd]"},{"text":" §e分数: "},{"score":{"objective":"个人-第一击杀数","name":"@e[tag=VMW]"}}]
execute @p[tag=2rd] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a2rd: "},{"selector":"@a[tag=2rd]"},{"text":" §e分数: "},{"score":{"objective":"个人-第二击杀数","name":"@e[tag=VMW]"}}]
