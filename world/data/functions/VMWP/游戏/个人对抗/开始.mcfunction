#计分板
scoreboard objectives add 个人-击杀数 playerKillCount
...
scoreboard players set @a[tag=游戏中] 爆破-金钱 25
...
title @a[tag=游戏中] subtitle [{"text":"§e§l结算时击杀数排名位列前二以获得胜利"}]
...
replaceitem entity @a[tag=游戏中] slot.armor.chest minecraft:leather_chestplate 1 0 {ench:[{lvl:1s,id:10s}],Unbreakable:1b,HideFlags:5,display:{color:8388863,Name:""},AttributeModifiers:[{UUIDMost:3618156733941892737L,UUIDLeast:-7584274578594019785L,Amount:13.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"generic.armor"}]}
xp -10000L @a 
stopsound @a record
...
scoreboard players tag @e[tag=VMW] add 开始1
