...
scoreboard players set @a[tag=PVE-RPK] 爆破-选择的主武器 113
scoreboard players set @a[tag=PVE-RPK] 爆破-选择的副武器 0
...
scoreboard players set @a[tag=C-GiantArmor] 爆破-选择的主武器 106
