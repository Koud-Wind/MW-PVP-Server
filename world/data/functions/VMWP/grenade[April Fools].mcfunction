...
execute @e[type=mw:smokegrenade260,tag=SmokeG] ~ ~ ~ particle largeexplode ~ ~ ~ 0 0 0 0 1 force
...
execute @a[tag=BuyUltimateW] ~ ~ ~ replaceitem entity @a[tag=InGame] slot.enderchest.13 mw:russian_weapons_case 1 0 {ench:[{lvl:1s,id:71s}],HideFlags:1,display:{Name:"§4Ultimate weapon box"},tag:["UltimateW"]}
...
execute @e[type=mw:flashgrenade262] ~ ~ ~ playsound minecraft:entity.wolf.howl ambient @a ~ ~ ~ 1 2
...
execute @e[type=mw:smokegrenade260,tag=ExplosiveG] ~ ~ ~ summon minecraft:creeper ~ ~0.5 ~ {Motion:[0.0d,2.0d,0.0d],powered:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:3,ShowParticles:0b}],Fuse:10s,ignited:1b,ExplosionRadius:30b,CustomName:"[Frag Grenade]",Silent:1b,CustomNameVisible:0b,Tags:["FragGrenade"]}
...
execute @e[type=minecraft:armor_stand,tag=Splash,score_ThrowingT=300] ~ ~ ~ playsound mw:flashbang ambient @a ~ ~ ~ 0.1 0.7
...
execute @e[type=mw:smokegrenade260,tag=ExplosionS] ~ ~ ~ effect @a[r=13] 25 1 50 true 
