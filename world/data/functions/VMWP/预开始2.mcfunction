...
execute @e[tag=VMW,score_爆破-选择时间=0,score_开始-选择模式=3,score_开始-选择模式_min=3] ~ ~ ~ scoreboard players operation @s 个人-地图 = @s 爆破-地图
execute @e[tag=VMW,score_爆破-选择时间=0,score_开始-选择模式=3,score_开始-选择模式_min=3] ~ ~ ~ function vmwp:游戏/求生对抗/开始
...
execute @a[score_选择地图_min=1,score_选择地图=1,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l地图选定为§fmap1"}]
execute @a[score_选择地图_min=2,score_选择地图=2,tag=选择地图] ~ ~ ~ scoreboard players set @e[tag=VMW] 爆破-地图 1
execute @a[score_选择地图_min=2,score_选择地图=2,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l地图选定为§fmap2"}]
execute @a[score_选择地图_min=3,score_选择地图=3,tag=选择地图] ~ ~ ~ scoreboard players set @e[tag=VMW] 爆破-地图 2
execute @a[score_选择地图_min=3,score_选择地图=3,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l地图选定为§fmap3"}]
execute @a[score_选择地图_min=4,score_选择地图=4,tag=选择地图] ~ ~ ~ scoreboard players set @e[tag=VMW] 爆破-地图 3
execute @a[score_选择地图_min=4,score_选择地图=4,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l地图选定为§fmap4"}]
execute @a[score_选择地图_min=5,score_选择地图=5,tag=选择地图] ~ ~ ~ scoreboard players set @e[tag=VMW] 爆破-地图 4
execute @a[score_选择地图_min=5,score_选择地图=5,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l地图选定为§fmap5"}]
execute @a[score_选择地图_min=6,score_选择地图=6,tag=选择地图] ~ ~ ~ scoreboard players set @e[tag=VMW] 爆破-地图 5
execute @a[score_选择地图_min=6,score_选择地图=6,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l地图选定为§fmap6"}]

execute @e[tag=VMW] ~ ~ ~ execute @s[tag=!半血模式] ~ ~ ~ execute @a[score_选择地图_min=21,score_选择地图=21,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l已启用§f半血模式"}]
...
execute @e[tag=VMW] ~ ~ ~ execute @s[tag=半血模式] ~ ~ ~ execute @a[score_选择地图_min=21,score_选择地图=21,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"§a§l已启用§f正常血量模式"}]
execute @e[tag=VMW] ~ ~ ~ execute @s[tag=半血模式] ~ ~ ~ execute @a[score_选择地图_min=21,score_选择地图=21,tag=选择地图] ~ ~ ~ scoreboard players tag @s add 切换
...
execute @e[tag=VMW,score_开始-选择模式=0] ~ ~ ~ execute @a[score_选择地图_min=20,score_选择地图=20,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"\n§e§l模式被更改为§f破点攻防"}]
...
execute @e[tag=VMW,score_开始-选择模式=1,score_开始-选择模式_min=1] ~ ~ ~ execute @a[score_选择地图_min=20,score_选择地图=20,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"\n§e§l模式被更改为§f团队死斗"}]
...
execute @e[tag=VMW,score_开始-选择模式=2,score_开始-选择模式_min=2] ~ ~ ~ execute @a[score_选择地图_min=20,score_选择地图=20,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"\n§e§l模式被更改为§f求生对抗"}]
...
execute @e[tag=VMW,score_开始-选择模式=3,score_开始-选择模式_min=3] ~ ~ ~ execute @a[score_选择地图_min=20,score_选择地图=20,tag=选择地图] ~ ~ ~ tellraw @a[tag=!PVE-游戏中] [{"text":"\n§e§l模式被更改为§f赏金爆破"}]
